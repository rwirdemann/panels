...
func main() {
	rootPanel := panels.NewPanel(1, panels.LayoutDirectionHorizontal, 100)
	...
	topPanel := panels.NewPanel(4, panels.LayoutDirectionNone, 50).
		WithContent(renderPanel).
		WithBorder()

	rightPanel.Append(topPanel)
	bottomPanel := panels.NewPanel(5, panels.LayoutDirectionHorizontal, 50)
	rightPanel.Append(bottomPanel)

	leftBottomPanel := panels.NewPanel(6, panels.LayoutDirectionNone, 50).
		WithContent(renderPanel).
		WithBorder()
